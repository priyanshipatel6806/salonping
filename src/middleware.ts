...
export async function middleware(request: NextRequest) {
  ...
  const protectedPaths = [
    ...
    '/analytics', '/services', '/staff', '/hours', '/blocked',
    '/intake', '/waitlist', '/loyalty', '/customise', '/settings',
  ]
...
export const config = {
  matcher: [
    '/((?!_next/static|_next/image|favicon.ico|api/|book/|auth/|cancel/|privacy|terms|pricing).*)',
  ],
}
