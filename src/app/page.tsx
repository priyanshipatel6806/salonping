...
const features = [
  {
    icon: '📱',
    title: 'Automatic SMS & WhatsApp Reminders',
    desc: 'Clients get reminders 48h, 24h, and 2h before their appointment — automatically. Zero effort from you.',
  },
  {
    icon: '🗓️',
    title: 'Beautiful Online Booking Page',
    desc: 'Your own branded booking link. Share it anywhere — Instagram bio, Google, WhatsApp — and let clients book 24/7.',
  },
  {
    icon: '💬',
    title: 'AI Assistant on Every Booking Page',
    desc: 'An intelligent chat widget answers client questions about services, pricing, and availability — day or night.',
  },
  {
    icon: '💸',
    title: 'Reduce No-Shows by 27%',
    desc: 'Salons using SalonPing see an average 27% drop in no-shows within the first month. That's real money back in your pocket.',
  },
  {
    icon: '⚡',
    title: 'Set Up in 5 Minutes',
    desc: 'No tech skills needed. Add your services, set your hours, get your booking link. Done.',
  },
  {
    icon: '✉️',
    title: 'Instant Owner Notifications',
    desc: 'Get notified the moment a new booking comes in. Always stay on top of your schedule.',
  },
]

const steps = [
  { n: '01', title: 'Create your account', desc: 'Sign up with just your email — no password needed.' },
  { n: '02', title: 'Add your services & hours', desc: 'Enter what you offer, how long each takes, and when you're open.' },
...
const testimonials = [
  {
    quote: "I used to lose $200–300 a week to no-shows. SalonPing basically pays for itself ten times over.",
    name: 'Aaliya M.',
    role: 'Independent Stylist, Toronto',
  },
  {
    quote: "My clients love being able to book themselves online at midnight. Bookings went up 40% in two months.",
    name: 'Priya K.',
    role: 'Salon Owner, Waterloo',
  },
  {
    quote: "Setup took me 5 minutes. The AI chat widget is a game-changer — it answers client DMs for me.",
    name: 'Simone R.',
    role: 'Stylist & Colourist, Vancouver',
  },
]

export default function LandingPage() {
  return (
    <div style={{background:'#0a0a0a', color:'#fff', fontFamily:'var(--font-geist-sans, system-ui, sans-serif)'}}>
      ...
      <nav style={{borderBottom:'1px solid rgba(255,255,255,0.06)', position:'sticky', top:0, zIndex:50,
        ...
        <div style={{maxWidth:1100, margin:'0 auto', padding:'0 24px', height:64, display:'flex', alignItems:'center', justifyContent:'space-between'}}>
          ...
          <div style={{display:'flex', alignItems:'center', gap:24}}>
            ...
            <Link href="/login"
              style={{background:`linear-gradient(135deg,#2a1f08,${GOLD})`, color:'#0a0a0a', fontWeight:700,
      ...
      <section style={{padding:'100px 24px 80px', textAlign:'center', position:'relative', overflow:'hidden'}}>
        ...
        <div style={{position:'absolute', top:'50%', left:'50%', transform:'translate(-50%,-60%)',
          width:600, height:400, borderRadius:'50%', background:`radial-gradient(ellipse,${GOLD}18 0%,transparent 70%)`,
          pointerEvents:'none'}} />
        ...
        <div style={{maxWidth:800, margin:'0 auto', position:'relative'}}>
          ...
          <h1 style={{fontSize:'clamp(40px,6vw,72px)', fontWeight:900, lineHeight:1.08, letterSpacing:'-2px', margin:'0 0 24px'}}>
          ...
          <div style={{display:'flex', gap:14, justifyContent:'center', flexWrap:'wrap'}}>
            <Link href="/login"
              style={{background:`linear-gradient(135deg,#2a1f08,${GOLD})`, color:'#0a0a0a', fontWeight:800,
                fontSize:16, padding:'16px 36px', borderRadius:14, textDecoration:'none', display:'inline-block'}}>
              Start free — no card needed
            </Link>
            <a href="#how-it-works"
              style={{background:'rgba(255,255,255,0.06)', color:'rgba(255,255,255,0.8)', fontWeight:600,
          ...
          <div style={{display:'flex', gap:48, justifyContent:'center', marginTop:64, flexWrap:'wrap'}}>
            {[
              { val: '27%', label: 'avg. no-show reduction' },
              { val: '5 min', label: 'to set up' },
              { val: '24/7', label: 'online bookings' },
            ].map(s => (
      ...
      <section id="features" style={{padding:'100px 24px'}}>
        <div style={{maxWidth:1100, margin:'0 auto'}}>
          ...
          <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(300px,1fr))', gap:20}}>
            {features.map(f => (
              <div key={f.title} style={{background:'rgba(255,255,255,0.03)', border:'1px solid rgba(255,255,255,0.07)',
      ...
      <section id="how-it-works" style={{padding:'80px 24px', borderTop:'1px solid rgba(255,255,255,0.06)'}}>
        <div style={{maxWidth:800, margin:'0 auto'}}>
          <h2 style={{fontSize:'clamp(28px,4vw,48px)', fontWeight:900, letterSpacing:'-1.5px', textAlign:'center', marginBottom:56}}>
      ...
      <section style={{padding:'80px 24px', borderTop:'1px solid rgba(255,255,255,0.06)'}}>
        <div style={{maxWidth:1100, margin:'0 auto'}}>
          <h2 style={{fontSize:'clamp(24px,3vw,40px)', fontWeight:900, letterSpacing:'-1px', textAlign:'center', marginBottom:48}}>
            Salon owners <span style={{color:GOLD}}>love it</span>
          </h2>
          <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(280px,1fr))', gap:20}}>
            {testimonials.map(t => (
              <div key={t.name} style={{background:'rgba(201,168,76,0.05)', border:'1px solid rgba(201,168,76,0.15)',
      ...
      <section style={{padding:'100px 24px', textAlign:'center', borderTop:'1px solid rgba(255,255,255,0.06)', position:'relative', overflow:'hidden'}}>
        <div style={{position:'absolute', top:'50%', left:'50%', transform:'translate(-50%,-50%)',
          width:500, height:300, borderRadius:'50%', background:`radial-gradient(ellipse,${GOLD}15 0%,transparent 70%)`,
          pointerEvents:'none'}} />
        <div style={{position:'relative', maxWidth:600, margin:'0 auto'}}>
          ...
          <p style={{fontSize:17, color:'rgba(255,255,255,0.5)', marginBottom:40, lineHeight:1.7}}>
            Join salon owners across Canada who've taken back control of their schedule — and their income.
          </p>
          <Link href="/login"
            style={{background:`linear-gradient(135deg,#2a1f08,${GOLD})`, color:'#0a0a0a', fontWeight:800,
      ...
      <footer style={{borderTop:'1px solid rgba(255,255,255,0.06)', padding:'36px 24px', textAlign:'center'}}>
        <div style={{display:'flex', alignItems:'center', justifyContent:'center', gap:8, marginBottom:16}}>
          ...
          <span style={{fontWeight:800, fontSize:16}}>SalonPing</span>
        </div>
        <p style={{fontSize:13, color:'rgba(255,255,255,0.25)', margin:0}}>
          © {new Date().getFullYear()} SalonPing. Built for salon owners who value their time.
        </p>
      </footer>
    </div>
  )
